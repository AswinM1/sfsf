...
export default function Hero() {
  return (
    ...
    >
      ...
      <Link href={"/dashboard"}>
      <button className="bg-neutral-200 text-black font-sans    px-4 py-2 rounded-md shadow-black/40 border border-neutral-700  shadow-lg hover:bg-neutral-400 cursor-pointer transition w-fit text-[15px]">
        Get Started 
      </button>
      </Link>
